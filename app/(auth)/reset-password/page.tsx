    ...
    <div className="w-full max-w-md p-8 bg-[#f8f3ea] rounded-3xl shadow-lg">
      <div className="space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-[#6b5d4d]">Please kindly set your new password</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <Input
                ...
                className="pr-10 py-6 bg-transparent border-[#6b5d4d] border-opacity-30 focus:border-[#6b5d4d] focus:ring-0"
              />
              <button
                type="button"
