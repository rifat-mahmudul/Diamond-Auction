      ...
      <div className="grid gap-8 md:grid-cols-6">
        ...
        <div className="col-span-2">
          ...
          <p className=" text-[#595959] text-[16px] my-3">
            Have questions? We&apos;re here to help! Below are answers to some of the most common inquiries about registering, bidding, and making purchases on our auction platform.
          </p>
          <Link href="/faq" >
