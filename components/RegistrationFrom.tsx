                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <select
                          {...field}
                          disabled={isLoading}
                          className="h-10 sm:h-12 rounded-md text-sm sm:text-base border border-primary px-3 w-full bg-primary"
                        >
                          <option className="bg-[#f5ede2]" value="">Select a user type</option>
                          <option className="bg-[#f5ede2]" value="bidder">Bidder</option>
                          <option className="bg-[#f5ede2]" value="seller">Seller</option>
                        </select>
                      </FormControl>
                      <FormMessage className="text-xs sm:text-sm" />
                    </FormItem>
