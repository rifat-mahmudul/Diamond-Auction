...
import { Phone, Mail, MapPin, Twitter, Instagram, MessageSquare } from "lucide-react"
                ...
                <div className="bg-[url('/assets/contactusBg.png')] bg-cover bg-center text-white p-8 md:w-2/5 pt-[32px] rounded-[16px]">
                    <div className="h-full flex flex-col ">
                        <div>
                            ...
                            <p className="mb-8 text-base text-[#C9C9C9] font-normal">Say something to start a live chat!</p>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="" {...field} className="!border-b-2 border-[#645949] rounded-none border-t-0 border-l-0 border-r-0" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type="email" placeholder="" {...field} className="!border-b-2 border-[#645949] rounded-none border-t-0 border-l-0 border-r-0" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                        ...
                                        <FormControl>
                                            ...
                                            >
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    <Label className="text-base text-[#645949] font-medium" htmlFor="general">General Inquiry</Label>
                                                </div>
                                                <div className="flex items-center space-x-2">
                                                    <RadioGroupItem value="support" id="support" />
                                                    <Label className="text-base text-[#645949] font-medium" htmlFor="support">Support</Label>
                                                </div>
                                                <div className="flex items-center space-x-2">
                                                    <RadioGroupItem value="business" id="business" />
                                                    <Label className="text-base text-[#645949] font-medium" htmlFor="business">Business</Label>
                                                </div>
                                            </RadioGroup>
                                        </FormControl>
                                        <FormMessage />
                            ...
                            <div className="flex justify-end relative">
                                ...
                                <div className=" absolute top-[50px] right-14 hidden md:block">
                                    <Image src="/assets/contact_under_img.png" alt="work 1" height={400} width={400} />
                                </div>
                            </div>
                        </form>
                    </Form>
