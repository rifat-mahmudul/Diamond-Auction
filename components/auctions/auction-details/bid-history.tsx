    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div className="flex gap-2 items-center text-base font-medium text-[#645949]">
          ...
          <p className="">{formatCurrency(startingBid)}</p>
        </div>
        <div className="flex gap-2 items-center text-base font-medium text-[#645949]">
          <p className="">Current Bid:</p>
          <p className="">{formatCurrency(currentBid)}</p>
        </div>
        <div className="flex gap-2 items-center text-base font-medium text-[#645949]">
          <p className="">Increment:</p>
          <p className="">{formatCurrency(bidIncrement)}</p>
        </div>
      </div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-[#f9f4e8] hover:bg-[#f9f4e8]">
              <TableHead className="border font-medium text-foreground py-3 px-4 w-1/4 min-w-[120px]">
                Date
              </TableHead>
              <TableHead className="border font-medium text-foreground py-3 px-4 w-1/4 min-w-[100px]">
                Bid
              </TableHead>
              <TableHead className="border font-medium text-foreground py-3 px-4 w-1/4 min-w-[100px]">
                User
          ...
          <TableBody>
            {token &&
              bidHistory.map((bid: Bid, index: number) => (
                <TableRow
                  key={index}
                  className="bg-[#f9f4e8] hover:bg-[#f9f4e8]"
                >
